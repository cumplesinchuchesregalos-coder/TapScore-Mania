...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'style_golden', name: 'Goldenrod', type: 'circle_style', price: 100, imageUrl: '/images/gold-coin.png', imageHint: 'gold coin' },
  { id: 'style_square', name: 'The Square', type: 'circle_style', price: 150, className: 'bg-primary' },
  { id: 'style_ring', name: 'The Ring', type: 'circle_style', price: 200, imageUrl: '/images/diamond-ring.png', imageHint: 'diamond ring' },
  { id: 'style_ghost', name: 'Ghost', type: 'circle_style', price: 250, imageUrl: '/images/cute-ghost.png', imageHint: 'cute ghost' },
];
